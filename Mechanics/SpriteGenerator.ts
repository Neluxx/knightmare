namespace Game {
  ...
  export class SpriteGenerator extends ƒAid.NodeSprite {
    ...
    public static generateAnimations(_spritesheet: ƒ.CoatTextured): void {
      ...
      rect = new ƒ.Rectangle(0, 157, 100, 33, ƒ.ORIGIN2D.BOTTOMLEFT);
      sprite.generateByGrid(rect, 22, new ƒ.Vector2(46, 0), 64, ƒ.ORIGIN2D.BOTTOMLEFT);
      ...
      sprite.generateByGrid(rect, 8, new ƒ.Vector2(46, 0), 64, ƒ.ORIGIN2D.BOTTOMLEFT);
      ...
      sprite.generateByGrid(rect, 10, new ƒ.Vector2(46, 0), 64, ƒ.ORIGIN2D.BOTTOMLEFT);
      ...
      sprite.generateByGrid(rect, 1, new ƒ.Vector2(46, 0), 64, ƒ.ORIGIN2D.BOTTOMLEFT);
