...
(function (Game) {
    ...
    class SpriteGenerator extends ƒAid.NodeSprite {
        ...
        static generateAnimations(_spritesheet) {
            ...
            //Golem ATTACK
            sprite = new ƒAid.SpriteSheetAnimation(Game.ACTION.GOLEM_ATTACK, _spritesheet);
            ...
            SpriteGenerator.animations[Game.ACTION.GOLEM_ATTACK] = sprite;
            //Golem DIE
            sprite = new ƒAid.SpriteSheetAnimation(Game.ACTION.GOLEM_DIE, _spritesheet);
            ...
            SpriteGenerator.animations[Game.ACTION.GOLEM_DIE] = sprite;
            //Golem DEAD
            sprite = new ƒAid.SpriteSheetAnimation(Game.ACTION.GOLEM_DEAD, _spritesheet);
            ...
            SpriteGenerator.animations[Game.ACTION.GOLEM_DEAD] = sprite;
            //Golem IDLE
            sprite = new ƒAid.SpriteSheetAnimation(Game.ACTION.GOLEM_IDLE, _spritesheet);
            ...
            SpriteGenerator.animations[Game.ACTION.GOLEM_IDLE] = sprite;
            //Golem WALK
            sprite = new ƒAid.SpriteSheetAnimation(Game.ACTION.GOLEM_WALK, _spritesheet);
            ...
            SpriteGenerator.animations[Game.ACTION.GOLEM_WALK] = sprite;
            //Witch IDLE
            sprite = new ƒAid.SpriteSheetAnimation(Game.ACTION.WITCH_IDLE, _spritesheet);
            ...
            SpriteGenerator.animations[Game.ACTION.WITCH_IDLE] = sprite;
            //Witch DIE
            sprite = new ƒAid.SpriteSheetAnimation(Game.ACTION.WITCH_DIE, _spritesheet);
            ...
            SpriteGenerator.animations[Game.ACTION.WITCH_DIE] = sprite;
            //Witch DEAD
            sprite = new ƒAid.SpriteSheetAnimation(Game.ACTION.WITCH_DEAD, _spritesheet);
            ...
            SpriteGenerator.animations[Game.ACTION.WITCH_DEAD] = sprite;
            //Witch WALK
            sprite = new ƒAid.SpriteSheetAnimation(Game.ACTION.WITCH_WALK, _spritesheet);
            ...
            SpriteGenerator.animations[Game.ACTION.WITCH_WALK] = sprite;
            //Witch ATTACK
            sprite = new ƒAid.SpriteSheetAnimation(Game.ACTION.WITCH_ATTACK, _spritesheet);
            ...
            SpriteGenerator.animations[Game.ACTION.WITCH_ATTACK] = sprite;
            //Wolf WALK
            sprite = new ƒAid.SpriteSheetAnimation(Game.ACTION.WOLF_WALK, _spritesheet);
            ...
            SpriteGenerator.animations[Game.ACTION.WOLF_WALK] = sprite;
            //Wolf DIE
            sprite = new ƒAid.SpriteSheetAnimation(Game.ACTION.WOLF_DIE, _spritesheet);
            ...
            SpriteGenerator.animations[Game.ACTION.WOLF_DIE] = sprite;
            //Wolf DEAD
            sprite = new ƒAid.SpriteSheetAnimation(Game.ACTION.WOLF_DEAD, _spritesheet);
            ...
            SpriteGenerator.animations[Game.ACTION.WOLF_DEAD] = sprite;
            //Wolf IDLE
            ...
            //Wolf ATTACK
            sprite = new ƒAid.SpriteSheetAnimation(Game.ACTION.WOLF_ATTACK, _spritesheet);
            ...
            SpriteGenerator.animations[Game.ACTION.WOLF_ATTACK] = sprite;
        }
